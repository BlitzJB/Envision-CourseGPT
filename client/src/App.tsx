    ...
    import FloatingDoubts from './components/FloatingDoubts'
    ...
    function App() { 
        ...
        return (<>
            {
                outline?.items[showSubheading.topic].subtopics[showSubheading.subtopic].text && <FloatingDoubts outline={outline} showSubheading={showSubheading} />
            }
